                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <ul class="navbar-nav ml-auto">
                            <div class="moive-add-title">
                                <h1 class="addtitle">EDIT USER DETAILS</h1>
                            </div>
        ...
        ?>
                                    <form action="userbd.php" method="POST">
                                        ...
                                        <div class="list1">
                                            ...
                                            <input type="text" class="i1" name="username" value="<?php echo $row['username'];?>">
                                        </div>
                                        <div class="list2">
                                            <label>Email</label><br>
                                            <input type="email" class="i2" name="email" value="<?php echo $row['email'];?>">
                                        </div>
                                        <div class="list3">
                                            <label>Password</label><br>
                                            <input type="password" class="i3" name="password" value="<?php echo $row['password'];?>">
                                        </div>
                                        <button type="submit" name="canbtn" class="btn_can">
                                                Cancel
                                            </button>
                                        <button type="submit" name="updatebtn" class="btn_update">Update</button>
                                    </form>
                                    <?php
    }
}
