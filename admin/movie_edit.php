                    ...
                    <input type="hidden" name="edit_id" value="<?php echo $row['movie_id'];?>">
                        <div class="movie-book">
                            <div class="add-movie">                        
                                <div class="mc">
                                    ...
                                    <select id="moviet" name="categorie" required>
                                        ...
                                        <option value="<?php echo $row['categorie'];?>"> Second movie</option>
                                        <option value="<?php echo $row['categorie'];?>"> Upcoming movie</option>
                            ...
                            <div class="movieline4">
                                ...
                                <div class="mtra">
                                    <input type="text" value="<?php echo $row['video_url'];?>" name="tra" class="moive-trailer" placeholder="Movie trailer link" required>
                                </div>
                            </div>
